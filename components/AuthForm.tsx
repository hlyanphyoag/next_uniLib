      ...
      return (
        <div className="flex flex-col gap-4 ">
            ...
            <p className = 'text-light-100'>
                {isSignIn ? 'Access the vast collections of resources, and stay updated' : 'Please complete all fields and upload the university ID to gain access to the library'}
            </p>
            <Form {...form}>
